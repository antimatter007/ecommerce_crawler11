# ecommerce_crawler/spiders/zara_spider.py
...
class ZaraSpider(scrapy.Spider):
    ...
    base_url = 'https://www.zara.com/in/en/search?searchTerm=mobile+phones'
    count = 1
    ...
    def parse(self, response):
        ...
        for i, link in enumerate(product_links):
            ...
            details['domain'] = 'zara.com'
            details['url'] = link
            details['title'] = titles[i].strip() if i < len(titles) else None
            details['brand'] = 'ZARA'  # Static as per domain
